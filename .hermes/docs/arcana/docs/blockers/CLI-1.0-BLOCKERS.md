...
|---|---|---|---|
| BLK-CLI-01 | External-agent launch group (`arcana launch codex/claude/gemini`) | No launch implementation; commands are TARGET in the master spec | One production adapter reaches a declared certification level; others documented |
