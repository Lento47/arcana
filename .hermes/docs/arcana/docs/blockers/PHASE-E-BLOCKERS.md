...
| BLK-E-03 | E3 TypeScript/JavaScript SDK 1.0 | **Governance surface DONE 2026-08-02** (`@arcana/sdk/v2/governance`: request builder with exact hashing, adapter hook, envelope verification; SDK suite 10/10). Remaining: RunProof verify client, stable error model, semver/compat policy, conformance pass | SDK 1.0 API + semver/compat policy + conformance pass |
