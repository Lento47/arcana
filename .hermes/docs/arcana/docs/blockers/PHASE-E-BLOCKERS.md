...
| BLK-E-06 | E6 framework adapters (Mastra/AI SDK/LangGraph/MCP apps) | **AI SDK-style + MCP hooks DONE 2026-08-02** (`governedTool` + `governedMcpTool`; 5 tests, SDK 22/22). Remaining: live PEP transport + Mastra/LangGraph | Framework tool calls map to canonical requests (DONE); PEP cannot be bypassed (hook-level DONE, live transport pending) |
