...
| Phase D — Distributed Authority | ACTIVE DEVELOPMENT, ~45–55% by playbook weighting; D-7 frozen (`arcana-phase-d7-local-distributed-authority`), D-8A proof batching implemented, **D-8B proof registration end-to-end + D-9 offline grant/lease policy + D-1 enrollment w/ HTTP + D-6B-T signed-envelope sync transport (2026-08-02)**; D-4 policy store/D-10 hostile-node eval partial or pending |
...
| Core suite | 1329 pass / 7 skip / 0 fail (1,336 tests, clean rerun 2026-08-02 incl. D-8B/D-9/D-1/D-6B-T suites) |
