...
| Phase F — Enterprise Control Plane | STARTED — F1..F6 cores implemented (2026-08-02): tenant model, RBAC, policy lifecycle, fleet, central approvals, audit archive; F7–F13 pending |
