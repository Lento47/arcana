...
| E6 Framework adapters | 10% | PARTIAL | **AI SDK-style governed tool hook IMPLEMENTED 2026-08-02** (`@arcana/sdk/v2/adapters`: `governedTool` maps tool calls to canonical requests, ALLOW-only execution, exact-request binding, framework approval cannot bypass the hook; 3 tests, SDK suite 20/20). Remaining: live PEP transport integration + Mastra/LangGraph/MCP adapters | BLK-E-06 |
