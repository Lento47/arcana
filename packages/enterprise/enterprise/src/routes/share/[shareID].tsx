import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@arcana/sdk/v2"
import { SessionTurn } from "@arcana/ui/session-turn"
import { SessionReview } from "@arcana/ui/session-review"
import { DataProvider } from "@arcana/ui/context"
import { FileComponentProvider } from "@arcana/ui/context/file"
import { WorkerPoolProvider } from "@arcana/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@arcana/ui/logo"
import { IconButton } from "@arcana/ui/icon-button"
import { ProviderIcon } from "@arcana/ui/provider-icon"
import { iife } from "@arcana/core/util/iife"
import { Binary } from "@arcana/core/util/binary"
import { NamedError } from "@arcana/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@arcana/ui/tabs"
import { MessageNav } from "@arcana/ui/message-nav"
import { FileSSR } from "@arcana/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@arcana/ui/pierre/worker").then((m) => ({
