...
export const ApprovalRecordSchema = Schema.Struct({
  ...
  route: Schema.optional(Schema.Literals(["LOCAL_TUI", "DESKTOP_PREFERRED", "DESKTOP_REQUIRED", "CENTRAL_REQUIRED"])),
  routingPolicyVersion: Schema.optional(Schema.String),
  localFallbackAllowed: Schema.optional(Schema.Boolean),
  riskClass: Schema.optional(Schema.Literals(["LOW", "MODERATE", "HIGH", "CRITICAL"])),
