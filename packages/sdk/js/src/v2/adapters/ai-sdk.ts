...
export type AuthorizationOutcome =
  | { decision: "ALLOW" }
  | { decision: "DENY" | "REQUIRE_APPROVAL"; reason: string }
 ...
 * reaches the tool's executor. If `executeExact` is provided, the tool
 * executes through it (enforcement boundary) rather than directly.
 */
