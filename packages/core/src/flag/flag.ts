...
export const Flag = {
  ...
  ARCANA_DISABLE_WARP_INTEGRATION: truthy("ARCANA_DISABLE_WARP_INTEGRATION"),
  ARCANA_SHOW_TTFD: truthy("ARCANA_SHOW_TTFD"),
  ARCANA_PROFILE_STARTUP: truthy("ARCANA_PROFILE_STARTUP"),
  /** Log session-switch hydrate timing (warm/cold, workspace change, ms). */
  ARCANA_PROFILE_SESSION_SWITCH: truthy("ARCANA_PROFILE_SESSION_SWITCH"),
  /** Opt out of idle prefetch for pinned/quick-switch sessions (Tier 1 rollback). */
  ARCANA_DISABLE_SESSION_PREFETCH: truthy("ARCANA_DISABLE_SESSION_PREFETCH"),
