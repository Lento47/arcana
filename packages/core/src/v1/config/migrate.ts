...
export function migrate(info: typeof ConfigV1.Info.Type) {
  return {
    ...
    compaction: info.compaction && {
      ...
      threshold_percent: info.compaction.threshold_percent,
      performance: info.compaction.performance,
      performance_max_input_tokens: info.compaction.performance_max_input_tokens,
      summary_max_input_tokens: info.compaction.summary_max_input_tokens,
    },
