        ...
        parameters: {
          ...
          properties: {
            ...
            models: {
              ...
              minItems: 2,
              maxItems: 5,
              description: 'OPTIONAL. Models as "provider/model" (e.g. ["anthropic/claude-sonnet-4-5", "openai/gpt-5.5", "arcana-proxy/x-ai/grok-4.20"]). When omitted, a roster is auto-built from credentialed providers (env-keyed providers first, then the Arcana Proxy catalog for diversity). Listed models without credentials are skipped, never fatal.'
            },
