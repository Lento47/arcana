...
- **v0.3.8** — Freeze evidence pack ([FREEZE-EVIDENCE-2026-08-06.md](docs/FREEZE-EVIDENCE-2026-08-06.md): real suite numbers, 16 evidence logs), governance protections ([FREEZE-GOVERNANCE.md](docs/FREEZE-GOVERNANCE.md)), freeze-evidence CI workflow, CURRENT-STATE.json reconciliation, audit-7 convergence campaign completion. See [STATUS.md](docs/STATUS.md).
