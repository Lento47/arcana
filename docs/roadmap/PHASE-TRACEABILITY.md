...
| F11 Enterprise API/automation | PARTIAL | `/api/enterprise/*` admin surface (F1-F12 cores mounted) + admin-event store + SIEM CEF export (4 core tests) + HTTP record/list/siem-export (14 HTTP integration tests + 2 event tests) | BLK-F-11 |
