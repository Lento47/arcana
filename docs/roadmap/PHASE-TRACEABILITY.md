...
| D6 Replay resistance | PARTIAL | reducers + transport replay protection + **execution ledger** (exactly-once claims, cross-node matrix, UNKNOWN_AFTER_*; 9 tests); PEP claim wiring pending | BLK-D-01 |
