...
| Phase D — Distributed Authority | ACTIVE DEVELOPMENT, ~45–55% by playbook weighting; D-7 frozen (`arcana-phase-d7-local-distributed-authority`), D-8A proof batching implemented, **D-8B proof registration end-to-end + D-9 offline grant/lease policy + D-1 enrollment/key rotation (2026-08-02)**; D-3–D-6/D-10 partial or pending |
...
| Core suite | 1319 pass / 7 skip / 0 fail (1,326 tests, clean rerun 2026-08-02 incl. D-8B registration/uploader + D-9 offline-policy + D-1 enrollment suites) |
