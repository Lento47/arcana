...
| Phase D — Distributed Authority | ACTIVE DEVELOPMENT, ~45–55% by playbook weighting; D-7 frozen (`arcana-phase-d7-local-distributed-authority`), D-8A proof batching implemented, **D-8B control-plane proof registration implemented (2026-08-02)**; D-1/D-3–D-6/D-8/D-9/D-10 partial or pending |
...
| Core suite | 1280 pass / 7 skip / 0 fail (1,287 tests, clean rerun 2026-08-02 incl. D-8B proof-registration suite) |
