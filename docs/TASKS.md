...
| E9 Protocol governance/compatibility | 5% | PARTIAL | PROTOCOL-GOVERNANCE (version lifecycle, deprecation, security advisory, extension registry, compatibility matrix, ownership) | BLK-E-09 |
...
| F5 Central approvals | PARTIAL | central queue: exact inspection, separation of duties, expiry, bulk deny, emergency revocation (4 tests) + escalation core (4 tests) + HTTP revoke/bulk-deny/escalation/approvals-list (RBAC; integration tested) + escalation console (PR #68) | BLK-F-05 |
